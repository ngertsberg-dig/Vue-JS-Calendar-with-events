...
// $(".delete-deduction").mouseover(function(){
//   var modalEventId = $(".modal-body").find('#event-id').html();
//   console.log(modalEventId);
//   alert('hell')
// })
...
var Calendar = Vue.component("Calendar", {
	...
	template: `
		<div class="calendar-container noselect">
          ...
          <h5 id = 'monthly-income'>Monthly Income : <div id = 'userInputAmount'>{{userInputVue}}</div> </h5>
          <div class = 'storage'>
